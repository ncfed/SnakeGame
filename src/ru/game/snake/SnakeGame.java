package ru.game.snake;

import ru.game.snake.main.GameplayManager;
import ru.game.snake.main.GameBoard;
import ru.game.snake.main.GameWindow;
...
public class SnakeGame {
    ...
    public static void main(String[] args) {
        ...
        String helpMessage = "The Snake Game, v2.0\n\n"
                + "Controls:\n"
        ...
        GameplayManager game = new GameplayManager(); //controller
        GameBoard board = new GameBoard(gameOptions); //model
        GameWindow window = new GameWindow(board); //view        
